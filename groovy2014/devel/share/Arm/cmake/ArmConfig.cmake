...
if("TRUE" STREQUAL "TRUE")
  set(Arm_SOURCE_PREFIX /home/roboops/2014Software/groovy2014/src/Arm)
  set(Arm_DEVEL_PREFIX /home/roboops/2014Software/groovy2014/devel)
  set(Arm_INSTALL_PREFIX "")
  set(Arm_PREFIX ${Arm_DEVEL_PREFIX})
else()
  set(Arm_SOURCE_PREFIX "")
  set(Arm_DEVEL_PREFIX "")
  set(Arm_INSTALL_PREFIX /home/roboops/2014Software/groovy2014/install)
...
if(NOT "/home/roboops/2014Software/groovy2014/src/Arm/include" STREQUAL "")
  set(Arm_INCLUDE_DIRS "")
  set(_include_dirs "/home/roboops/2014Software/groovy2014/src/Arm/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'Arm' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'roboops <roboops@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'Arm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/roboops/2014Software/groovy2014/src/Arm/${idir}'.  Ask the maintainer 'roboops <roboops@todo.todo>' to fix it.")
    endif()
