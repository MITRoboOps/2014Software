...
int ServoMotor::getPosition(int channel){
    return currentPosition[channel];
}
...
void ServoMotor::openS(int channel){
    setAbsolutePosition((unsigned short)openedPosLim[channel], channel);

}

void ServoMotor::closeS(int channel){
    setAbsolutePosition((unsigned short)closedPosLim[channel] - 1000, channel);
