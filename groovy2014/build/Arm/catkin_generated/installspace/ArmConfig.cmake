...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'Arm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/roboops/2014Software/groovy2014/install/${idir}'.  Ask the maintainer 'roboops <roboops@todo.todo>' to fix it.")
    endif()
